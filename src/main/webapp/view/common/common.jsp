...
<head>
    ...
    <!-- alert插件 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/view/message2/css/jquery.my-message.1.1.css" />
    <script type="text/javascript" src="${pageContext.request.contextPath}/view/message2/js/jquery.my-message.1.1.js"></script>
    <!-- end -->
    <!--弹出层 开始 -->
